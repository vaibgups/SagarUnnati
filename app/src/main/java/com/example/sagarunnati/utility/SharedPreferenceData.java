...
public class SharedPreferenceData {
    ...
    private static final String SETTINGS_NAME = "default_sagar_unnati";

    private static SharedPreferenceData sSharedPrefs;
    private SharedPreferences mPref;
    private SharedPreferences.Editor mEditor;
    private boolean mBulkUpdate = false;
    private final String LOGIN_RESPONSE = LoginResponse.class.getSimpleName();
    ...
    public static SharedPreferenceData getInstance(Context context) {
        if (sSharedPrefs == null) {
            sSharedPrefs = new SharedPreferenceData(context.getApplicationContext());
        }
        return sSharedPrefs;
    }
